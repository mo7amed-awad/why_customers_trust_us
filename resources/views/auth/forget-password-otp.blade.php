        ...
        <div
            ...
            <div class="col-lg-6 col-md-8 col-12 h-100 form-scroll" style="overflow: auto;">
                ...
                <div class="w-100 d-flex justify-content-center align-items-start h-100">
                    <form method="POST" action="{{ route('client.create.password') }}" method="POST" class="w-100 d-flex flex-column justify-content-center  my-auto p-lg-5 p-3 rounded-4 text-black bg-white">
                        @csrf
