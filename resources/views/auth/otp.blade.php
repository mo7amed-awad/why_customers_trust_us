...
@section('content')
        ...
        <div
            ...
            <div class="col-lg-6 col-md-8 col-12 h-100 form-scroll" style="overflow: auto;">
                ...
                <div class="w-100 d-flex justify-content-center align-items-start h-100">
                    <form method="POST" action="{{ route('client.register.store') }}" method="POST" class="w-100 d-flex flex-column justify-content-center  my-auto p-lg-5 p-3 rounded-4 text-black bg-white">
                        @csrf
                        ...
                        <div class="col-md-12">
                            <!-- ✅ إضافة dir="ltr" لفرض الاتجاه من اليسار لليمين -->
                            ...
                            <div class="d-flex justify-content-center my-md-3">
                                <a type="button" class="text-secondary fw-medium text-decoration-underline resend">
                <span>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content py-4">
                ...
                <div class="modal-body d-flex justify-content-center flex-column align-items-center ">
                    <div class="w-50 d-flex justify-content-center py-2"><img style="width: 50px;" class="img-fluid" src="{{asset('assets/imgs/home/sucess.gif')}}" />
                    </div>

                    <div class=" w-75 d-flex flex-column align-items-center">
                        <h5 class="py-2 mb-0">تم تسجيلك بنجاح!</h5>
                        <p class="fs-6 text-center py-2">تم إرسال رابط التأكيد إلى بريدك الإلكتروني يرجى التحقق من صندوق
                            الوارد واضغط على الرابط لتغيير كلمة المرور!</p>
                        <a href="index.html"
                           class="btn bg-primary-color  px-5 btn m-auto text-white rounded-2 gap-2 my-2 py-2 w-100"> ابدا الان </a>
                    </div>
                </div>
            </div>
        </div>
    ...
    @push('scripts')
        <script>
            ...
            // دالة التحكم في تفعيل وتعطيل الزر
            ...
            // ✅ دالة الانتقال التلقائي بين المربعات
            function setupOTPInputs() {
                ...
                inputs.forEach((input, index) => {
                    ...
                    input.addEventListener('paste', function(e) {
                        ...
                        if (pastedData) {
                            ...
                            // الانتقال للمربع الأخير أو التالي الفارغ
                ...
                // دالة تحديث الكود النهائي وتفعيل الزر
            ...
            // --- تشغيل العد أول مرة عند تحميل الصفحة ---
            startCountdown();
            setupOTPInputs();
            ...
            resendBtn.addEventListener('click', function(e) {
                ...
                const tempUserId = document.querySelector('input[name="temp_user_id"]').value;

                fetch("{{ route('client.resend-otp') }}", {
                    method: 'POST',
                    headers: {
                    ...
                    .then(data => {
                        if (data.success && data.otp) {
                            ...
                            document.querySelectorAll('.verify').forEach(input => input.value = '');
