            ...
            <div class="row">
                <div class="col-md-6">
                    <h6 class="text-success">
                        {{ __('trans.result') }} <span class="text-info">({{ $Rentals->total() }})</span>
                    </h6>
                </div>
                ...
                <div class="col-md-6">
                    <form action="" method="GET">
                        <div class="row">
                            ...
                            <!-- Price -->
                            <div class="col-6 mb-3">
                                <select class="form-select select2" name="price" onchange="this.form.submit()">
                                    <option value="" {{ request('price') ? '' : 'selected' }}>{{ __('trans.price') }} ({{ __('trans.all') }})</option>
            ...
            <div class="row py-4">
                ...
                @else
                    <div class="col-12 text-center py-5">
                        <img src="{{ asset('empty-state.png') }}" alt="No Rentals" class="mb-3" style="max-width: 150px;">
                        <h5 class="text-dark">
                            @if(lang('ar'))
                                {{ 'عذرًا، لا توجد سيارات متاحة حاليًا.' }}
                            @elseif(lang('en'))
                                {{ 'Sorry, no rentals available at the moment.' }}
                            @endif
                        </h5>
