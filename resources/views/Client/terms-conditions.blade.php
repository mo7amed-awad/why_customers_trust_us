...
<div class="container-fluid mb-lg-5 mb-md-4 mb-3">
    <div class="row   align-items-center  py-2 ">
        <div
            ...
            <img class="w-100 w-100 object-fit-cover" src="assets/imgs/home/terms-cover.png" />
            <div
                ...
                <div class="row justify-content-center w-100">
                    <div class="col-lg-10">
                        ...
                        <p class="text-white" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="500">
                            Your Use of This Site Means You Agree to These Terms               </p>
...
<div class="container py-lg-5 py-3 mb-lg-5 mb-3 section-top">
    <div class="row py-2">
        <h1 class=" fw-semibold fs-24" >Terms & Conditions – Solutioners</h1>
    </div>
    <div class="row ">
        <h6 class="py-2 fw-bold">Clause 1</h6>
        <p class="fs-6">
    ...
    <div class="row ">
        ...
        <ul style="list-style: disc; list-style-position: inside;">
            <li>Device or browser information (for website analytics)</li>
            <li>Device or browser information (for website analytics)</li>
            <li>Device or browser information (for website analytics)</li>
            <li>Device or browser information (for website analytics)</li>
