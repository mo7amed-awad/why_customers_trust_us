        ...
        <div class="col-lg-7 overflow-hidden position-relative">
            <div class="row bg-white py-3 gap-3 px-2 rounded-3 border-color border mb-3">
                ...
                <div class="col-12">
                    ...
                    <div class="position-relative">
                        <div class="slider-for py-2" dir="ltr">
                            @foreach($images as $index => $image)
                                <div>
                                    <div class="img-container d-flex justify-content-center align-items-center rounded-3 bg-Secondary-color" style="height: 400px;">
                    ...
                    <div class="slider-nav py-2" dir="ltr">
                        @foreach($images as $image)
                            <div class="px-1">
                                <div class="img-slider rounded-1 bg-Secondary-color" style="height: 80px; cursor: pointer;">
