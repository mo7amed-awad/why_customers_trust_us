    ...
    <div class="row  justify-content-lg-between   justify-content-center  gap-md-0 gap-3">
        <div class="col-lg-6 col-md-4 d-flex justify-content-center">
            <div
                ...
                <img class="w-100 h-100 object-fit-cover rounded-4" src="{{asset('assets/imgs/home/about-cover.jpg')}}">
            </div>
        </div>
        <div class="col-lg-5 col-md-6 col-12" data-aos="fade-up" data-aos-duration="1500">
            ...
            <p class="text-secondary py-2 fs-18" style="max-width: 90%;">At Emerge, we design furniture that feels as good
                as it looks — timeless pieces made to elevate your everyday living.
            </p>
            <p class="text-secondary py-2 fs-18" style="max-width: 90%;">
                <span class="text-black fw-bold">Our mission</span> is to bring together modern design, natural materials, and
                thoughtful craftsmanship, creating spaces that inspire comfort and connection.
            </p>
        ...
        <div class="col-12">
            <ul class="nav nav-pills products gap-2" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active rounded-pill " id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home"
                            type="button" role="tab" aria-controls="pills-home" aria-selected="true">All Cars</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link rounded-pill " id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile"
                            type="button" role="tab" aria-controls="pills-profile" aria-selected="false">New Cars</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link rounded-pill " id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact"
                            type="button" role="tab" aria-controls="pills-contact" aria-selected="false">Used Cars
                    </button>
                </li>

            </ul>
        </div>
        <div class="tab-content py-2 col-12 " id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab"
                 tabindex="0">

                <div class="row py-2 gy-4  overflow-hidden tabslider">
...
<div class="container  py-lg-5 py-3 overflow-hidden position-relative">
    <div class="row py-2">
        <div class="col-12 d-flex justify-content-between">
            <h3 class="fs-32 fw-semibold mb-3">Top Car Brands</h3>
    ...
    <div class="row   brands regular py-5 ">
        ...
        <div class="">
            <div class=" overflow-hidden">
                <div class=" d-flex align-items-center justify-content-center img-slider overflow-hidden">
                    <img src="assets/imgs/home/logo/Logo-2.png">
                </div>
        ...
        <div class="">
            <div class=" overflow-hidden">
                <div class=" d-flex align-items-center justify-content-center img-slider overflow-hidden">
                    <img src="assets/imgs/home/logo/Logo-3.png">
                </div>
        ...
        <div class="">
            <div class=" overflow-hidden">
                <div class=" d-flex align-items-center justify-content-center img-slider overflow-hidden">
                    <img src="assets/imgs/home/logo/Logo.png">
                </div>
...
<div class="py-lg-5 py-3 text-white mb-5" style="background-image: url(assets/imgs/home/blue-card.png);">
    <div class="container  py-lg-5 py-3 ">
        <div class="row ">
            <div class="col-lg-9 col-md-10 col-11">
                <h3 class="lh-base fw-semibold h4-home">Why Choose Us</h3>
                <p class="lh-base fs-18">
                    At Alshamla, we redefine how you experience everything related to cars. Whether you’re buying, selling,
                    renting, or servicing your vehicle, we bring it all together in one smart, reliable, and innovative
                    platform.
                </p>
                ...
                <span><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M7.75 12L10.58 14.83L16.25 9.17004" stroke="white" stroke-width="1.5"
                          stroke-linecap="round" stroke-linejoin="round" />
                            ...
                            <span class="px-0 fw-bold">All-in-One Car Platform</span>
                        </div>
                        <p>Discover a wide selection of new and used cars in one place — compare models, explore details, and find
                ...
                <span><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M7.75 12L10.58 14.83L16.25 9.17004" stroke="white" stroke-width="1.5"
                          stroke-linecap="round" stroke-linejoin="round" />
                            ...
                            <span class="px-0 fw-bold">Smart reminders for renewals and bills</span>
                        </div>
                        <p>Discover a wide selection of new and used cars in one place — compare models, explore details, and find
                            the perfect match for you.</p>
