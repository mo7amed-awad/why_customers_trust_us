...
@section('content')
    <form method="POST" action="{{ route(activeGuard() . '.biddings.store') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="datetime-local" name="bid_time" id="bid_time" class="form-control" required value="">
            </div>
