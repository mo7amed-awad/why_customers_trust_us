...
@section('content')
    <form method="POST" action="{{ route(activeGuard() . '.rentals.update', $Model) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" name="price" id="price" class="form-control" required value="{{ $Model['price'] }}">
            </div>
                ...
                @foreach ($Model->images as $key => $image)
                    <tr class="sortable-row" data-id="{{ $image['id'] }}">
                        ...
                        <td style="text-align:center;">
                            ...
                            <i class="fa-solid fa-trash-can cursor-pointer" data-id="{{ $image['id'] }}" data-table="rental_images"></i>
                        </td>
                    </tr>
                @endforeach
            </tbody>
