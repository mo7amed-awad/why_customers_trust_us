...
@section('content')
    <form method="POST" action="{{ route(activeGuard() . '.specifications.store') }}" enctype="multipart/form-data">
        @csrf
        <div class="text-center">
            <img src="{{ asset(setting('logo')) }}" class="rounded mx-auto text-center" id="image-preview" height="200px" style="    filter: drop-shadow(1px 1px 5px #0d0d0d);">
        </div>
