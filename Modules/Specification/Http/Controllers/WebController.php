...
class WebController extends BasicController
{
    ...
    public function datatable(Request $request)
    {
        ...
        return DataTables::of($query)
            ->addColumn('actions', function ($Model) {
                return view('specification::layouts.actions', ['Model' => $Model]);
            })
            ->editColumn('title_ar', function ($Model) {
                return view('specification::layouts.title_ar', ['Model' => $Model]);
            })
            ->editColumn('title_en', function ($Model) {
                return view('specification::layouts.title_en', ['Model' => $Model]);
            })
            ->addColumn('status', function ($Model) {
                return view('specification::layouts.status', ['Model' => $Model]);
            })
            ->addColumn('image', function ($Model) {
                return view('specification::layouts.image', ['Model' => $Model]);
            })
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            $Model->image = Upload::UploadFile($request->image, 'Specifications');
        }
    ...
    public function show($id)
    {
        ...
        return view('specification::show', compact('Model'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('specification::edit', compact('Model'));
    }
