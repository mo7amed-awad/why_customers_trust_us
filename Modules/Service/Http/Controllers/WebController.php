    ...
    public function datatable(Request $request)
    {
        ...
        return DataTables::of($query)
            ->addColumn('actions', function ($Model) {
                return view('service::layouts.actions', ['Model' => $Model]);
            })
            ->editColumn('title_ar', function ($Model) {
                return view('service::layouts.title_ar', ['Model' => $Model]);
            })
            ->editColumn('title_en', function ($Model) {
                return view('service::layouts.title_en', ['Model' => $Model]);
            })
            ->addColumn('status', function ($Model) {
                return view('service::layouts.status', ['Model' => $Model]);
            })
            ->addColumn('image', function ($Model) {
                return view('service::layouts.image', ['Model' => $Model]);
            })
