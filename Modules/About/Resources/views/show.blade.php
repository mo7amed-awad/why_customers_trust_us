            ...
            <div class="col-lg-10">
                ...
                <div class="card shadow-sm">
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4">
                            <div class="d-flex align-items-center mb-3">
                                <h5 class="mb-0">@lang('trans.title_en')</h5>
                            </div>
                            <div class="p-3 bg-light rounded border">
                                <p class="mb-0 fw-bold">{{ $Model->title_en }}</p>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            <div class="d-flex align-items-center mb-3">
                                <h5 class="mb-0">@lang('trans.title_ar')</h5>
                            </div>
                            <div class="p-3 bg-light rounded border" dir="rtl">
                                <p class="mb-0 fw-bold">{{ $Model->title_ar }}</p>
                            </div>
                        </div>
                    ...
                    <div class="card-footer bg-light text-center">
                        <a href="{{ route(activeGuard() . '.about.index') }}" class="btn btn-secondary">
