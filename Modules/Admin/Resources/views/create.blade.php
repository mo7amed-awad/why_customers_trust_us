...
@section('content')
    <form action="{{ route(activeGuard() . '.admins.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="text-center">
            <img src="{{ asset(setting('logo')) }}" class="rounded mx-auto text-center" id="image"
                style="max-width: 100%;max-height: 200px" style="max-width: 100%">
        </div>
        <div class="row">
            <div class="col-md-6 ">
                                    ...
                                    <ul class="multiple-checkbox">
                                        ...
                                        <li>
                                            ...
                                            <label style="color: red;" class="custom-control-label"
                                                for="all-{{ $key }}">@lang('trans.' . $key)</label>
                                            <ul class="mx-3">
                                                <!--List Step-2 -->
