...
@section('content')
    <form method="POST" action="{{ route(activeGuard() . '.whycustomerstrustus.update', $Model) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="row">
            ...
            <div class="col-12 text-center my-3">
                <img src="{{ asset($Model->image ?? setting('logo')) }}"
                     id="image-preview"
                     alt="معاينة الصورة"
                     style="max-width: 300px; max-height: 300px; border: 2px solid #ddd; border-radius: 8px; padding: 5px;">
            </div>
